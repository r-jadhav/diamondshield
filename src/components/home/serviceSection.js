                        ...
                        <div className="row custom-mar-20" data-aos="fade-down" data-aos-duration="1000">
                            <div className="col-sm-6 custom-pad-20">
                                <div className="kservice text-center mb-20">
                                    ...
                                    <div className="kservice-content">
                                        <h5 className="kservice-content-title"><Link to="/service-details">Website <br />Development</Link></h5>
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-6 custom-pad-20">
                                <div className="kservice text-center mb-20">
                                    ...
                                    <div className="kservice-content">
                                        <h5 className="kservice-content-title"><Link to="/service-details">Graphic <br />Designing</Link></h5>
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-6 custom-pad-20">
                            ...
                            <div className="col-sm-6 custom-pad-20">
                                <div className="kservice text-center mb-20">
                                    ...
                                    <div className="kservice-content">
                                        <h5 className="kservice-content-title"><Link to="/service-details">Digital <br />marketing</Link></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
